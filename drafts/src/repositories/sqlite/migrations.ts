import type { SqliteMigration } from "./sqliteClient";

const initCoreSql = `PRAGMA foreign_keys = ON;
...
const seedDefaultsSql = `INSERT OR IGNORE INTO tags (
  id,
  name,
  color,
  is_system,
...
export const DEFAULT_SQLITE_MIGRATIONS: SqliteMigration[] = [
  {
    version: "0001_init_core",
    description: "Initialize TimeAura core tables",
    sql: initCoreSql,
  },
  {
    version: "0002_seed_defaults",
